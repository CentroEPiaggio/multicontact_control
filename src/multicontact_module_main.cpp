...
#include "multicontact_module.hpp"
...
int main(int argc, char* argv[])
{
    ...
    rf.setDefaultContext( "multicontact_control" );  
    rf.configure(argc, argv);
    // create my module
    multicontact_module multicontact_mod = multicontact_module( argc, argv, "multicontact_control", MODULE_PERIOD, rf );
    
    // run the module
    multicontact_mod.start();
    multicontact_mod.runModule( rf );
